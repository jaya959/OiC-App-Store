...
class ModelCell: UICollectionViewCell {
    ...
    @IBAction func addToFavorite(_ sender: Any) {
        ...
        if favButton.currentImage ==  UIImage(named:"ic_favorite_violet") {
            favButton.setImage(UIImage(named:"ic_favorite_outline_violet"), for: .normal)
        }
        else {
            favButton.setImage(UIImage(named:"ic_favorite_violet"), for: .normal)
        }
    }
}
